...
Contained are script two files, one to determine quantum yield from HPLC data and absorbances, and one to visually analyze UV-Vis data (more files to come). 
