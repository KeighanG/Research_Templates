...
%nprocshared=16
%mem=128GB
#P Opt=(Tight) Freq wB97XD/6-311++G** SCRF=(Solvent=Water)

Jug: Singlet ground state optimization & frequency calculation in water
...
Jug: One-electron reduced state optimization & frequency calculation in water
