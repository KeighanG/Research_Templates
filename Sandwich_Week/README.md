# Sandwich Week 2025 Data and Code Templates
This repository contains: 
  - Chemical actinometry data and code using 2-nitrobenzaldehyde
  - The scripts required to analyze singlet oxygen experimental data using a chemical probe of furfuryl alcohol 
  - Gaussian16 output data for Juglone and Perinaphthenone excited state calculations
